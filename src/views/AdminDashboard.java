...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnFishType, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 130, -1));

        btnBuyers.setText("Buyers");
        jPanel2.add(btnBuyers, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 130, -1));

        btnSales.setText("Sales");
        jPanel2.add(btnSales, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 130, -1));

        btnProfile.setText("My Profile");
        jPanel2.add(btnProfile, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 130, -1));
        ...
        jPanel2.add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 130, -1));

        btnUserMgmt.setText("User Management");
        jPanel2.add(btnUserMgmt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 130, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 170, 400));

        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 490, -1));

        lblUserInfo.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lblUserInfo.setText("Email:    |   Role: Admin   |   Status:");
        jPanel3.add(lblUserInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, -1, -1));

        lblWelcome1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblWelcome1.setText("Welcome, Admin");
        jPanel3.add(lblWelcome1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 510, 90));
    ...
    private void btnLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogoutActionPerformed
        int c = javax.swing.JOptionPane.showConfirmDialog(this, "Are you sure you want to logout?", "Confirm Logout", javax.swing.JOptionPane.YES_NO_OPTION);
    ...
    }//GEN-LAST:event_btnFishTypeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        } catch (Exception ex) { java.util.logging.Logger.getLogger(AdminDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex); }

...
public class FishTypeForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 360, -1, -1));

        jPanel3.setBackground(new java.awt.Color(0, 102, 153));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 220, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("FISH TYPE FORM");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        jPanel3.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 130, -1));
        jPanel3.add(txtCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 130, -1));
        ...
        jPanel3.add(addRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 90, 30));
        ...
        jPanel3.add(updateRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 90, 30));
        ...
        jPanel3.add(deleteRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 273, 90, 30));
        ...
        jPanel3.add(clearForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 90, 30));

        cmbCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel3.add(cmbCat, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 130, 20));
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 30, 240, 320));
    ...
    public void loadData(String kw) {
        ...
        new config().displayData(
            "SELECT fish_type_id AS 'ID', fish_code AS 'Code', fish_name AS 'Fish Name', category AS 'Category' " +
            "FROM tbl_fish_type WHERE fish_name LIKE ? OR fish_code LIKE ? OR category LIKE ? ORDER BY fish_name",
            tblFish, k, k, k);
